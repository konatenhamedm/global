...
class ApiTypeController extends ApiInterface
{
    ...
    #[OA\Get(
        ...
        description: "Retourne la liste complète de tous les types (données de référence)."
    )]
    #[OA\Response(
        response: 200,
                ...
                new OA\Property(
                    ...
                    items: new OA\Items(
                        properties: [
                            ...
                            new OA\Property(property: "libelle", type: "string", example: "Type exemple"),
    ...
    #[OA\Get(
        ...
        description: "Retourne les détails d\'un type à partir de son identifiant."
    )]
    #[OA\Parameter(
        name: 'id',
        in: 'path',
    ...
    #[OA\Post(
        ...
        description: "Crée un nouveau type dans la liste de référence.",
    ...
    {
        $type = new Type();
        $type->setLibelle($request->request->get('libelle'));
        $type->setCode($request->request->get('code'));
        $type->setCreatedBy($this->userRepository->find($request->request->get('userUpdate')));
        $type->setUpdatedBy($this->userRepository->find($request->request->get('userUpdate')));
    ...
    #[OA\Post(
        summary: "Modifier un type existant",
        description: "Met à jour les informations d\'un type identifié par son ID.",
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\MediaType(
                mediaType: "multipart/form-data",
    ...
    #[OA\Parameter(
        ...
        in: 'path',
        required: true,
        description: "Identifiant unique du type à modifier",
        schema: new OA\Schema(type: 'integer', example: 1)
    )]
    #[OA\Response(
        response: 200,
    ...
    #[OA\Delete(
        ...
        description: "Supprime définitivement un type à partir de son identifiant."
    )]
    #[OA\Parameter(
        name: 'id',
        in: 'path',
        required: true,
        description: "Identifiant unique du type à supprimer",
        schema: new OA\Schema(type: 'integer', example: 1)
    )]
    #[OA\Response(
        response: 200,
    ...
    #[OA\Delete(
        ...
        description: "Supprime une liste de types en passant leurs IDs dans le corps de la requête.",
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\JsonContent(
                properties: [
    ...
    #[OA\Tag(name: 'type')]
    public function deleteAll(Request $request, TypeRepository $repository): Response
    {
        try {
            foreach ($request->get('ids') as $key => $value) {
                $type = $repository->find($value['id']);
                if ($type != null) {
