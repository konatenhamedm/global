...
/**
 * @extends ServiceEntityRepository<Superficie>
 */
class SuperficieRepository extends ServiceEntityRepository
{
    ...
    public function add(Superficie $entity, bool $flush = false): void
    {
    ...
    public function remove(Superficie $entity, bool $flush = false): void
    {
